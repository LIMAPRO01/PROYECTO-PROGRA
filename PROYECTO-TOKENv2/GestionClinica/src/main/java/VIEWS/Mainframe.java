...
public class Mainframe extends javax.swing.JFrame {
   ...
   public Mainframe(String rol) {
       ...
       public Mainframe() {
        initComponents();
        habilitarTodosBotones(true);
    }

    private void configurarBotonesPorRol() {
        switch (rolUsuario.toLowerCase()) {
            case "administrador":
                // Administrador tiene acceso a todos los botones
                habilitarTodosBotones(true);
                break;
            case "recepcionista":
            case "Recepcionista":    
                // Ejemplo: Recepcionista no puede acceder a Usuarios ni Médicos
                jButtonUsuarios.setEnabled(false);
                jButton2.setEnabled(false); // botón Médicos
                // Otros botones que quieras deshabilitar
                break;
            case "médico":
            case "medico":
            case "Medico":
                // Ejemplo: Médico solo puede acceder a Citas y Recetas
                habilitarTodosBotones(false);
                jButtonCita.setEnabled(true);
                jButton3.setEnabled(true); // botón Recetas
                break;
            default:
                // Por defecto deshabilitar todo
                habilitarTodosBotones(false);
                break;
        }
    }

    private void habilitarTodosBotones(boolean estado) {
        jButtonPaciente.setEnabled(estado);
        jButton2.setEnabled(estado);
        jButtonCita.setEnabled(estado);
        jButton3.setEnabled(estado);
        jButton4.setEnabled(estado);
        jButton5.setEnabled(estado);
        jButtonUsuarios.setEnabled(estado);
    }
...
this.dispose();// TODO add your handling code here:
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        MedicamentoForm med = new MedicamentoForm();
    ...
    private void btnEnviarCorreoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarCorreoActionPerformed
        // TODO add your handling code here:
        EnviarCorreoForm correo = new EnviarCorreoForm();
