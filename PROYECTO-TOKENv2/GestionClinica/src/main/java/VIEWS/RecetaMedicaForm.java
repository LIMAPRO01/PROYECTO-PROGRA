...
import API.PdfGenerator; // Importa la clase PdfGenerator
import Models.RecetaMedica; // Importa la clase RecetaMedica
 ...
 seleccionarComboPorNombre(jComboBoxMedicos, MedicoNombreCompleto); 
  ...
  fecha1.setText("Hoy es " +dia+ " de " + meses[month -1]+ " de " +year); 
    ...
    private void initComponents() {
        ...
        btnGenerarReceta.setText("IMPRIMIR");
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createSequentialGroup()
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel7Layout.createSequentialGroup()
                        ...
                        .addGap(38, 38, 38)
                        .addComponent(btnEnviarCorreo, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE))
                            ...
                            .addGroup(jPanel7Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addGroup(jPanel7Layout.createSequentialGroup()
                                        ...
                                        .addGap(23, 23, 23)
                                        .addComponent(jComboBoxMedicos, javax.swing.GroupLayout.PREFERRED_SIZE, 155, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    // Abrimos el formulario de detalles y le pasamos el ID de la receta
    DetalleRecetaForm detalleForm = new DetalleRecetaForm(idReceta);
    ...
    private void btnGenerarRecetaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarRecetaActionPerformed
        // TODO add your handling code here:String pacienteNombre = jComboBoxPacientes.getSelectedItem().toString();
    String pacienteNombre = jComboBoxPacientes.getSelectedItem().toString(); // <-- ESTA LÍNEA ES LA CLAVE
    String medicoNombre = jComboBoxMedicos.getSelectedItem().toString();
    String indicaciones = txtIndicaciones.getText();
    String fechaEmision = txtFecha.getText(); // Asumiendo que ya está formateada
    ...
    private void btnEnviarCorreoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnviarCorreoActionPerformed
        ...
        File recetaPdf = new File("C:\\Users\\Mario\\Music\\PROYECTO-TOKEN\\GestionClinica\\Receta_JUAN_PEREZ.pdf");  // Cambia esta ruta por la real
    File facturaPdf = new File("C:\\Users\\Mario\\Music\\PROYECTO-TOKEN\\GestionClinica\\DetalleFactura_1.pdf"); // Cambia esta ruta por la real

    // Verifica que los archivos existan antes de enviar
    if (!recetaPdf.exists() || !facturaPdf.exists()) {
        JOptionPane.showMessageDialog(this, "No se encontraron los archivos PDF para enviar.");
        return;
    }

    // Correo del destinatario (por ejemplo, el correo del paciente)
    String destinatario = "chester2223@gmail.com"; // Cambia por el correo real

    // Configuración SMTP y credenciales
    String smtpHost = "smtp.gmail.com"; // Cambia si usas otro proveedor
    String smtpPort = "587";             // Puerto para TLS
    String username = "clinicaregional.mensajeria@gmail.com";  // Tu correo
    String password = "rtdk lwpg hvgl xcrp";         // Tu contraseña o contraseña de aplicación
    ...
    // Enviar en un hilo para no bloquear la interfaz
    new Thread(() -> {
        try {
            // Enviar receta
            emailSender.sendEmail(destinatario, subject, body, recetaPdf);
            // Enviar factura
            emailSender.sendEmail(destinatario, subject, body, facturaPdf);

            // Mostrar mensaje de éxito en el hilo de la interfaz
            javax.swing.SwingUtilities.invokeLater(() -> {
                JOptionPane.showMessageDialog(this, "Correo electrónico enviado correctamente.");
            });
