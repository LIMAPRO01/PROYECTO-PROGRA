  ...
  private void limpiarCampos() {
   ...
   //copia los datos de la tabla a los txt
        jTable1.getSelectionModel().addListSelectionListener(e -> {
            ...
            Combogen.setSelectedItem(Genero);
...
private void verPacientes() {
   try {
    ...
    private void initComponents() {
        ...
        Combogen.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "M", "F" }));
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(Combogen, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE)))
    ...
    try {
        ...
        String genero = Combogen.getSelectedItem()!= null ? Combogen.getSelectedItem().toString() : "";
