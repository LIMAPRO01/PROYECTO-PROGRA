...
public class UsuarioForm extends javax.swing.JFrame {
    ...
    private void limpiarForm() {
        ...
        txtUsuario.setText("");
        txtContra.setText("");
        ComboRol.setSelectedIndex(0); // Resetea selección del ComboBox
        txtIDmedico.setText("");
    ...
    public UsuarioForm() {
        ...
        jTable1.getSelectionModel().addListSelectionListener(e -> {
            ...
            for (int i = 0; i < ComboRol.getItemCount(); i++) {
                    if (ComboRol.getItemAt(i).equals(Rol)) {
  ...
  private void cargarUsuarios() {
    ...
    private void initComponents() {
        ...
        ComboRol.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Administrador", "recepcionista", "Medico", " " }));
...
try {
   ...
   boolean rolvalido = Arrays.stream(rolesValidos)
           ...
           if (!rolvalido){
               JOptionPane.showMessageDialog(this, "Ingrese un rol válido. Administrador, Recepcionista o Medico.");
               return;
           }
