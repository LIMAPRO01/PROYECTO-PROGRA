   ...
   try {
    ...
    try {
        ...
        if (nombre.isEmpty() || apellido.isEmpty()|| especialidad.isEmpty()|| telefono.isEmpty()|| email.isEmpty()) {
            ...
            if (!email.matches("^[\\w.-]+@[\\w.-]+\\.(com|net)$")) {
        JOptionPane.showMessageDialog(null, "Correo inválido. Debe contener '@' y terminar en .com o .net");
        txtEmail.requestFocus();
        return;
    }
                JOptionPane.showMessageDialog(null, "Datos correctos. Procediendo a guardar...");
    ...
    JOptionPane.showMessageDialog(this, "El Medico ya está registrado. (verifique el dato en la tabla).");
    return;
    }
    //Guardar y mostrar Resultado
         ...
         if (Resultado) {
             ...
             JOptionPane.showMessageDialog(this, "Error al agregar el Medico. (verifique los datos.)");
         }
    }catch (Exception ex) {
        ex.printStackTrace ();
    ...
    private void BtnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnActualizarActionPerformed
     try {
        int selectedRow = jTable1.getSelectedRow();
        if (selectedRow == -1) {
            JOptionPane.showMessageDialog(this, "Selecciona un Medico para actualizar.");
            return;
        }
     ...
     String fechaHoy = LocalDate.now().format(formatoFecha);
        ...
        if (resultado) {
            ...
            JOptionPane.showMessageDialog(this, "Error al actualizar el medico.");
        }
