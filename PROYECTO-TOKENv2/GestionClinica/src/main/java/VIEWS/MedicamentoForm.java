...
private void verMedicamentos() {
   ...
   try {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1020, 170));
        ...
        jPanel1.add(jPanel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 340, 1020, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 410, 1020, 230));
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 170, 1020, 170));
...
try {
      ...
      try {
        ...
        stockVal = Integer.parseInt(stock);
      } catch (NumberFormatException e) {
        JOptionPane.showMessageDialog(this, "Precio o stock no tienen un formato válido.");
        return;
      }
      ...
      medicamento.setPrecio(precioVal);
      medicamento.setStock(stockVal);
...
try {
    ...
    private void BtnMovActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnMovActionPerformed
     MovimientoStockForm Movimiento = new MovimientoStockForm();
