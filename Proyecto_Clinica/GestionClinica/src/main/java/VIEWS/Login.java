...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 140, 350, 50));
        ...
        jPanel1.add(jButtonLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 240, 160, 40));
        ...
        jPanel1.add(jCheckBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 200, 20, 20));

        jLabel2.setText("Ingrese Nombre de usuario");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 30, 200, 20));
        ...
        try{
            ...
            if (u != null && u.isActivo()) {
                ...
                if (u.getRol().equalsIgnoreCase("Administrador")
                        || u.getRol().equalsIgnoreCase("Medico")
                        || u.getRol().equalsIgnoreCase("Recepcionista")) {
